...
REM ********************************************BEGIN customize
SET PATH=E:\code\learn_assembly_language\Masm615
SET INCLUDE=E:\code\learn_assembly_language\Masm615\INCLUDE
SET LIB=E:\code\learn_assembly_language\Masm615\LIB
REM ********************************************END customize
